...
public class FileController {
    ...
    public Result<Map<String, Object>> uploadFile(
            ...
            @Parameter(description = "文件分类（image、video、document）") @RequestParam(value = "category", required = false, defaultValue = "default") String category,
    ...
    public Result<String> getFileUrl(
        ...
        return Result.successWithMessageAndData("获取文件URL成功", url);
    }

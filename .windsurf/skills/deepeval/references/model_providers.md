...
approaches. The framework allows you to use various providers including OpenAI, Azure OpenAI, Anthropic Claude, Google
Gemini, AWS Bedrock, Ollama (local models), and more through direct integrations or the LiteLLM proxy.
...
- Anthropic Claude: `anthropic.claude-3-opus-20240229-v1:0`, `anthropic.claude-3-sonnet-20240229-v1:0`,

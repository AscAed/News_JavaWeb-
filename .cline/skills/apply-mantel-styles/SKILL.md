...
When creating visual diagrams or frontend components, you can apply the following style guidelines to ensure consistency
with the Mantel brand identity.
...
This information should help you maintain visual consistency with the Mantel brand across diagrams and frontend
components.

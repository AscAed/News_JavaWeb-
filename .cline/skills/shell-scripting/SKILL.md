...
Guidance for writing reliable, maintainable bash scripts following modern best practices. Emphasises simplicity,
automated tooling, and defensive programming without over-engineering.
...
**Critical**: If your script grows too large (1000+ lines) or complex, consider offering to rewrite it in a proper
language (Python, Go, etc.) before it becomes unmaintainable.

...
LLM-as-a-Judge quality assessment for agents. Monitors AgentCore Runtime endpoints or CloudWatch LogGroups. Integrates
with Strands and LangGraph via OpenTelemetry/OpenInference.
...
**Quality Metrics**: Helpfulness, Correctness, Faithfulness, ResponseRelevance, Conciseness, Coherence,

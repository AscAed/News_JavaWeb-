...
1. **AWS AgentCore Observability** - Managed service with GenAI dashboard, automatic instrumentation (for agents using
   AgentCore services)
...
in [GenAI Observability Dashboard](https://console.aws.amazon.com/cloudwatch/home#gen-ai-observability).
